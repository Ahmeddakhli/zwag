...
class GeneralSettingController extends Controller
{
    ...
    public function general()
    {
        ...
        return view('admin.setting.general', compact('pageTitle','timezones','currentTimezone', 'packages'));
    }
    ...
    public function generalUpdate(Request $request)
    {
        $request->validate([
            ...
            'default_package' => 'required|exists:packages,id'
        ]);
        ...
        $general->default_package_id = $request->default_package ?? 0;
        $general->save();
    ...
    public function systemConfigurationSubmit(Request $request)
    {
        ...
        $general->chat_attachment = $request->chat_attachment ? Status::ENABLE : Status::DISABLE;
        $general->save();
