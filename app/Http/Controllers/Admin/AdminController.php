...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $widget['purchasedAmount'] = PurchaseHistory::sum('package_details->price');
        $widget['totalInterests'] = UserInterest::count();
        $widget['totalIgnoredProfiles'] = IgnoredProfile::count();
        $widget['totalReports'] = Report::count();
