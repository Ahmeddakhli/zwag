...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'ظهرت كلمة المرور في تسريب بيانات. يرجى اختيار كلمة مرور مختلفة.',
    ],
    ...
    'custom' => [
        ...
        'birth_date.before'            => 'تاريخ الميلاد لا يمكن أن يكون بعد اليوم',
        'religion.required'            => 'الدين مطلوب',
        'gender.required'              => 'حقل الجنس مطلوب',
        'gender.in'                    => 'يجب أن يكون الجنس ذكر أو أنثى فقط',
        'profession.required'          => 'حقل المهنة مطلوب',
        'profession.string'            => 'يجب أن تكون المهنة نصية',
        'financial_condition.required' => 'حقل الحالة المالية مطلوب',
        'financial_condition.string'   => 'يجب أن تكون الحالة المالية نصية',
        'smoking_status.required'      => 'حقل عادات التدخين مطلوب',
        'smoking_status.in'            => 'يجب أن تكون عادات التدخين 0 أو 1',
        'drinking_status.required'     => 'حقل حالة الشرب مطلوب',
        'drinking_status.in'           => 'يجب أن تكون حالة الشرب 0 أو 1',
        'profession.*.string'          => 'يجب أن تكون المهنة نصية',
        'language.required'            => 'حقل اللغة مطلوب',
        'language.*.string'            => 'يجب أن تكون اللغة نصية',
        'pre_city.required'            => 'حقل المدينة الحالية مطلوب',
        'per_country.required'         => 'حقل الدولة الدائمة مطلوب',
        'per_city.required'            => 'حقل المدينة الدائمة مطلوب',
    ],
];
