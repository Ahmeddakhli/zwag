                                        ...
                                        <div class="chatbox-left__searchbox">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <label class="form--label"
                                                       for="search-box">@lang('Search Member')</label>
                                                    ...
                                                    <form class="chatForm" action="#" autocomplete="off"
                                                        ...
                                                        <div class="input--group">
                                                            <input class="form-control form--control" name="message"
                                                                   type="text" placeholder="@lang('Type Your Message')">
                                                            <label class="form--label"
                                                                   for="search-box">@lang('Type Your Message')</label>
                                                            <ul
