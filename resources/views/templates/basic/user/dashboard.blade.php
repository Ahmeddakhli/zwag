...
@section('content')
    ...
    @if (auth()->user()->kv != App\Constants\Status::CUR_BOTH)KYC_VERIFIED)
        @php
            $kyc = getContent('kyc.content', true);
        @endphp
        @if (auth()->user()->kv == App\Constants\Status::CUR_BOTH)KYC_UNVERIFIED && auth()->user()->kyc_rejection_reason)
        ...
        @elseif(auth()->user()->kv == App\Constants\Status::CUR_BOTH)KYC_UNVERIFIED)
        ...
        @elseif(auth()->user()->kv == App\Constants\Status::CUR_BOTH)KYC_PENDING)
    ...
    <div class="row gy-4 justify-content-center">
        ...
        <div class="dashboard-wrapper col-xxl-4 col-md-6">
            <div class="dashboard-card d-flex align-items-center flex-wrap">
                ...
                <div class="dashboard-card__content text-start">
                    <h4 class="dashboard-card__title d-block mt-0">{{ @$user->limitation->image_upload_limit == -1 ? trans('Unlimited') : (@$user->limitation->image_upload_limit - @$user->total_images > 0 ? @$user->limitation->image_upload_limit - @$user->total_images : 0) }}</h4>
