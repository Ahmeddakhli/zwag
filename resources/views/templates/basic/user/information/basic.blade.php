                    ...
                    <div class="login__wrapper basic-information">
                        <form class="info-form" action="{{ route('user.data.submit', 'basicInfo') }}" autocomplete="off" method="POST">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-sm-6">
                                    <div class="input--group">
                                        <div class="input-group">
                                            ...
                                            <input class="form-control form--control checkUser" id="mobile" name="mobile" type="text" value="{{ old('mobile') }}" placeholder="none" required>
                                            <label class="form--label always-on-top" for="mobile">@lang('Mobile')</label>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="input--group">
                                        <input class="form-control form--control" name="pre_state" type="text" value="{{ old('pre_state', $user->state) }}">
                                        <label class="form--label">@lang('State')</label>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="input--group">
                                        <input class="form-control form--control" name="pre_zip" type="text" value="{{ old('pre_zip', $user->zip) }}">
                                        <label class="form--label">@lang('Zip Code')</label>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="input--group">
                                        <input class="form-control form--control" name="pre_city" type="text" value="{{ old('pre_city', $user->city) }}" required>
