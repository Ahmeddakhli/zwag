                                ...
                                <div class="public-profile">
                                    <div class="team-card border-0" style="width: 100%; display: inline-block;">
                                        <div class="team-card__img mx-auto">
                                            <img class="team-card__img-is" src="{{ $member->profilePicture() }}" alt="@lang('Profile Image')">
                                        </div>
                            ...
                            <div class="text-center">
                                ...
                                @else
                                    <small class="text--danger">
                                        @lang('Viewing contact will charge ') <span class="fw-600">{{ @$general->global_package->contact_view_charge }} {{ __(gs('cur_text')) }}</span>
