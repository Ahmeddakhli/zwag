                    ...
                    <tbody>
                        @forelse($supports as $support)
                            <tr>
                                ...
                                <td>
                                    @if ($support->priority == App\Constants\Status::CUR_BOTH)PRIORITY_LOW)
                                        <span class="badge badge--dark">@lang('Low')</span>
                                    @elseif($support->priority == App\Constants\Status::CUR_BOTH)PRIORITY_MEDIUM)
                                        <span class="badge  badge--warning">@lang('Medium')</span>
                                    @elseif($support->priority == App\Constants\Status::CUR_BOTH)PRIORITY_HIGH)
