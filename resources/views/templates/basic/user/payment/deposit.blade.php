...
@section('content')
    <div class="row justify-content-center">
        <form action="{{ route('user.payment.purchase.package') }}" method="post" class="deposit-form">
            @csrf
                                ...
                                <div class="deposit-info__input">
                                    <div class="deposit-info__input-group input-group">
                                        ...
                                        <input type="number" step="any" name="amount"
                                            ...
                                            value="{{ session('package_data')['price'] }}" autocomplete="off" disabled
                                            required>
                                    </div>
                                </div>
                            </div>
