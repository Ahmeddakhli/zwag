                        ...
                        <table class="table table--light">
                            ...
                            @forelse($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if($item->priority == App\Constants\Status::CUR_BOTH)PRIORITY_LOW)
                                            <span class="badge badge--dark">@lang('Low')</span>
                                        @elseif($item->priority == App\Constants\Status::CUR_BOTH)PRIORITY_MEDIUM)
                                            <span class="badge  badge--warning">@lang('Medium')</span>
                                        @elseif($item->priority == App\Constants\Status::CUR_BOTH)PRIORITY_HIGH)
